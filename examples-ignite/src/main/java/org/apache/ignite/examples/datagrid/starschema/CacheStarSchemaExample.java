...
public class CacheStarSchemaExample {
    ...
    private static final String FACT_CACHE_NAME = CacheStarSchemaExample.class.getSimpleName() + "MyFact";

    /** Replicated cache name. */
    private static final String DIM_STORE_CACHE_NAME = CacheStarSchemaExample.class.getSimpleName() + "MyDimStore";

    /** Replicated cache name. */
    private static final String DIM_PROD_CACHE_NAME = CacheStarSchemaExample.class.getSimpleName() + "MyDimProd";
