 ...
 */
package com.beam.examples.complete.game;

import static org.apache.beam.vendor.guava.v32_1_2_jre.com.google.common.base.MoreObjects.firstNonNull;

import java.util.HashMap;
import java.util.Map;
import com.beam.examples.common.ExampleUtils;
import com.beam.examples.complete.game.utils.GameConstants;
import com.beam.examples.complete.game.utils.WriteToBigQuery.FieldInfo;
import com.beam.examples.complete.game.utils.WriteWindowedToBigQuery;
...
public class StatefulTeamScore extends LeaderBoard {
  ...
  public static class UpdateTeamScoreFn
     ...
     * execution.
     *
     * <p>{@link StateId} annotation assigns an identifier to
     ...
     * StateId} that matches the state declaration. The type of
